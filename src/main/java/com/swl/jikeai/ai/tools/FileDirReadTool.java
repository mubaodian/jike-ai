...
public class FileDirReadTool extends BaseTool{
    ...
    @Tool("Read the directory structure to retrieve all files and subdirectories under the specified path.")
    public String readDir(
            @P("Relative path of the directory. If empty, the entire project structure will be read.")
