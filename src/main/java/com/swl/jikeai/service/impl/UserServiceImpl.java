...
import static com.swl.jikeai.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String getEncryptPassword(String originalPassword) {
        final String SALT = "mubaodian";
        return DigestUtils.md5DigestAsHex((originalPassword + SALT).getBytes());
    }
}
